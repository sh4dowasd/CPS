...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_read_more__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../js/read-more */ "./src/js/read-more.js");
/* harmony import */ var _js_read_more__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_js_read_more__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _js_popups__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../js/popups */ "./src/js/popups.js");
/* harmony import */ var _js_popups__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_js_popups__WEBPACK_IMPORTED_MODULE_1__);
...
var lPopupBtn = document.querySelector('.hamburger');
var feedPopupBtn = document.querySelectorAll('.popup-feedback');
var CallPopupBtn = document.querySelectorAll('.popup-call');
var closeBtn = document.querySelectorAll('.close-popup');
var lPopup = document.querySelector('.left-popup');
var feedPopup = document.querySelector('.popup_feedback');
var CallPopup = document.querySelector('.popup_call');
var popup = document.querySelectorAll('.popup');
var body = document.querySelector('body');
var html = document.querySelector('html');
var lContainer = document.querySelector('.left-container');
var lSection = document.querySelector('.left-section');
var closebtn = document.querySelector('.popup__close-left');
var unlock = true;
var lock = false;
var timeout = 300;
lPopupBtn.addEventListener('click', function (e) {
  lPopup.classList.toggle('open');
  lContainer.style.opacity = '1';
  lContainer.style.transform = 'translateX(0)';
  lock = false;
  bodyLock();
  lPopup.addEventListener('click', function (e) {
...
var el_2 = document.querySelector('.el-2');
var el_3 = document.querySelector('.el-3');
var ex_1 = document.querySelector('.ex-1');
var ex_2 = document.querySelector('.ex-2');
var ex_3 = document.querySelector('.ex-3');
var text1 = document.querySelector('.btn-text1');
var text2 = document.querySelector('.btn-text2');
var text3 = document.querySelector('.btn-text3');
var showAllBtn = document.querySelector('.show-all-btn');
var bl_1 = document.querySelectorAll('.br-bl');
var bl_2 = document.querySelectorAll('.br-bl-two');
var showAllBtnTwo = document.querySelector('.show-all-btn-two');
var t_1 = document.querySelectorAll('.t-hide');
var t_2 = document.querySelector('.t-hide-two'); // Read More
...
bl_1.forEach(function (x) {
  return x.classList.toggle('hide');
});
showAllBtn.addEventListener('click', function (e) {
  bl_1.forEach(function (x) {
    return x.classList.toggle('hide').remove;
  });
...
t_1.forEach(function (x) {
  return x.classList.toggle('hide');
});
showAllBtnTwo.addEventListener('click', function (e) {
  t_1.forEach(function (x) {
    return x.classList.toggle('hide').remove;
  });
...
var technicsSlider = document.querySelector('.technics-slider');
var priceSlider = document.querySelector('.price-slider');

if (window.innerWidth <= 767) {
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](brandsSlider, {
    slidesPerView: 1,
    spaceBetween: 16,
    slideClass: 'swiper-slide',
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](technicsSlider, {
    slidesPerView: 1,
    spaceBetween: 16,
    slideClass: 'swiper-slide',
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__["Pagination"]],
  ...
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](priceSlider, {
    slidesPerView: 1,
    spaceBetween: 16,
    slideClass: 'swiper-slide',
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__["Pagination"]],
